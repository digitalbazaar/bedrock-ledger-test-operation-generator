...
bedrock.events.on(
  'bedrock-ledger-test-operation-generation.add-targets', async payload => {
    console.log('111111111111111', JSON.stringify(payload, null, 2));
    await _jobQueue.jobQueue.add(payload, {
